...
ifneq ($(SATURN_BUILD),)
include vendor/saturn/config/BoardConfigSaturn.mk
endif
...
ifneq ($(SATURN_BUILD),)
ifneq ($(wildcard device/saturn/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/saturn/sepolicy/common/sepolicy.mk)
endif
endif
